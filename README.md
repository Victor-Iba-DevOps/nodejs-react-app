...
в который копируются исходные файлы с репозитория, включая [reactapp.yml](https://github.com/Victor-Iba-DevOps/nodejs-react-app/blob/main/reactapp.yml), \
...
в kubernetes-кластер подается для развертывания (или обновления, если он там уже присутствует) файл конфигурации [reactapp.yml](https://github.com/Victor-Iba-DevOps/nodejs-react-app/blob/main/reactapp.yml). \
